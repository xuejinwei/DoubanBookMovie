...
public class AutoNewLineLinearLayout extends LinearLayout {
    ...
    public AutoNewLineLinearLayout(Context context, int horizontalSpacing, int verticalSpacing) {
        super(context);
        this.mContext = context;
    }
    ...
    public AutoNewLineLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (pos != null) {
                ...
                Log.i("AutoLinearlayout", "AutoNextLineLinearlayout-----------error");
            }
        }
    }
    ...
    public int getPosition(int IndexInRow, int childIndex) {
        if (IndexInRow > 0) {
            return getPosition(IndexInRow - 1, childIndex - 1) + getChildAt(childIndex - 1).getMeasuredWidth() + DensityUtil.dp2px(8);
        }
